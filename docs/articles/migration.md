...
[`box::use`](https://klmr.me/box/reference/use.md) has no return value.
Instead, it automatically creates an alias with the module/package name
in the calling scope *if no names are attached* (see below). To override
the alias name, specify it as as a named argument:
...
[`box::use`](https://klmr.me/box/reference/use.md) allows (and
...
via [`box::help`](https://klmr.me/box/reference/help.md) (see below).
...
[`box::use`](https://klmr.me/box/reference/use.md) declarations apply to
