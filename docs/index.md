...
[`box::use`](https://klmr.me/box/reference/use.md) provides a
...
`require` functions. [`box::use`](https://klmr.me/box/reference/use.md)
is more explicit, more flexible, and less error-prone than `library`. At
its simplest, it provides a direct replacement:
...
[`box::use`](https://klmr.me/box/reference/use.md) to not attach any
...
The following [`box::use`](https://klmr.me/box/reference/use.md)
...
[`box::use`](https://klmr.me/box/reference/use.md) are restricted to the
current scope: we can load and attach names *inside* a function, and
...
[`box::use`](https://klmr.me/box/reference/use.md). Modules can also be
nested inside directories, such that self-contained projects can be
