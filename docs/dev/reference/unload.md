...
[`box::use`](https://klmr.me/box/dev/reference/use.md) declaration will
...
followed by [`box::use`](https://klmr.me/box/dev/reference/use.md),
...
[`box::use`](https://klmr.me/box/dev/reference/use.md) call.
`box::reload` attempts to re-attach these same names. This only works if
the corresponding [`box::use`](https://klmr.me/box/dev/reference/use.md)
...
[`box::use`](https://klmr.me/box/dev/reference/use.md), [module
