...
- Improve the import performance by changing the way loaded packages are
  detected ([\#380](https://github.com/klmr/box/issues/380)).
...
- Prevent accidental misuse by checking that arguments to
  [`box::file()`](https://klmr.me/box/dev/reference/file.md) and
  [`box::export()`](https://klmr.me/box/dev/reference/export.md) are
  unnamed ([\#334](https://github.com/klmr/box/issues/334)).
...
- Add [`box::topenv()`](https://klmr.me/box/dev/reference/topenv.md)
...
- Modules without any `@export` declarations now export all visible
  ...
  [`box::export()`](https://klmr.me/box/dev/reference/export.md) inside
  the module.
...
- Improve error messages when calling
  [`box::unload()`](https://klmr.me/box/dev/reference/unload.md) or
  [`box::reload()`](https://klmr.me/box/dev/reference/unload.md) with an
...
- Improve error messages when a module cannot be found or when there’s a
  ...
  [`box::use()`](https://klmr.me/box/dev/reference/use.md) declaration.
...
- Permit specifying exports by calling
  [`box::export()`](https://klmr.me/box/dev/reference/export.md) instead
  of via `@export` declarations
...
- Make [`box::help()`](https://klmr.me/box/dev/reference/help.md) work
  with attached objects
  ([\#170](https://github.com/klmr/box/issues/170)).
