...
[`box::use`](https://klmr.me/box/dev/reference/use.md)) correspond to a
mesh of several interconnected environments.
...
[`box::use`](https://klmr.me/box/dev/reference/use.md), the rules are
...
[`box::use`](https://klmr.me/box/dev/reference/use.md) expressions.
...
[`box::use`](https://klmr.me/box/dev/reference/use.md) call, the alias
...
[`box::use`](https://klmr.me/box/dev/reference/use.md) with a non-empty
