...
use [module event hooks](https://klmr.me/box/reference/mod-hooks.md).
...
[`box::use`](https://klmr.me/box/reference/use.md) for information on
declaring exports via `@export`.
