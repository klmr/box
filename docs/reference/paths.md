...
- caller:
  ...
  [`box::use`](https://klmr.me/box/reference/use.md) was invoked.
...
[`box::use`](https://klmr.me/box/reference/use.md), or the script’s path
if the calling code is not a module.
