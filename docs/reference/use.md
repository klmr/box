...
See the vignette at
[`vignette('box', 'box')`](https://klmr.me/box/articles/box.md) for
...
[`box::export`](https://klmr.me/box/reference/export.md) function, but
using declarative `@export` tags is generally preferred.
...
[`box::export()`](https://klmr.me/box/reference/export.md) without
...
[`box::name`](https://klmr.me/box/reference/name.md) and
[`box::file`](https://klmr.me/box/reference/file.md) give information
about loaded modules.
[`box::help`](https://klmr.me/box/reference/help.md) displays help for a
module’s exported names.
[`box::unload`](https://klmr.me/box/reference/unload.md) and
[`box::reload`](https://klmr.me/box/reference/unload.md) aid during
module development by performing dynamic unloading and reloading of
modules in a running R session.
[`box::export`](https://klmr.me/box/reference/export.md) can be used as
an alternative to `@export` comments inside a module to declare module
exports.
