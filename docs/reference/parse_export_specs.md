...
2.  When applied to a [`box::use`](https://klmr.me/box/reference/use.md)
    call, the imported names are exported. This can be the module name
    itself, any attached names, or both. All names introduced by the
    [`box::use`](https://klmr.me/box/reference/use.md) call are
    exported. See [`use`](https://klmr.me/box/reference/use.md) for the
    rules governing what names are introduced into the scope, and thus
    exported.
