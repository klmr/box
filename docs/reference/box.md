...
- [`box::file`](https://klmr.me/box/reference/file.md)

- [`box::name`](https://klmr.me/box/reference/name.md)

- [`box::register_S3_method`](https://klmr.me/box/reference/register_S3_method.md)

- [mod-hooks](https://klmr.me/box/reference/mod-hooks.md)

## Interactive use

Functions for use in interactive sessions and for testing.

- [`box::help`](https://klmr.me/box/reference/help.md)

- [`box::unload`](https://klmr.me/box/reference/unload.md),
  [`box::reload`](https://klmr.me/box/reference/unload.md),
  [`box::purge_cache`](https://klmr.me/box/reference/unload.md)
