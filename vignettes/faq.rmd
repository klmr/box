...
In practice, this means that modules inside the global module search path (set via the environment variable `R_BOX_PATH` or `getOption('box.path')`), modules need to be located in nested folders.
